...
namespace LifeGameX
{
    public class SubstanceCapsule : ILifeComponent, IIdentification, IRandomObject
    {
        ...
        public Stimulus Few { get; set; }

        public Stimulus Much { get; set; }
        ...
        public SubstanceCapsule(Life life, Substance substance, double max = 100, double min = 0, double transferLimit = 100)
        {
            if (life == null)
            ...
            this.Weight = 1;
            life.Resources.Add(substance, this);
            life.SubstanceCapsuleList.Add(this);
